  ...
  <div class="back-layer">
    <div class="dialog-box" @click.stop>
      ...
      <a-tabs defaultActiveKey="1" @change="callback">
        <a-tab-pane tab="基本资料" key="1">
          <a-form layout="inline" :form="vform">
            ...
            <a-form-item label="谷歌验证码开关" class="switch-box">
              <a-switch
                :defaultChecked="detail.isGoogleVerficationEnabled==1"
        ...
        <a-tab-pane tab="目录链接栏表" key="2" v-if="!admin" forceRender >
...
export default class EditAdminPanel extends Vue {
  ...
  submitEdit() {
    let p = {
      googleVerficationSecret: this.googleVerficationSecret === "" ? this.detail.googleVerficationSecret : this.googleVerficationSecret,
      id: this.detail.id,

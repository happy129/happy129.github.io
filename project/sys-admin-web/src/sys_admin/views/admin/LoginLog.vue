  ...
  <div class="page-container">
    ...
    <a-form class="mt10" layout="inline">
      ...
      <a-form-item style="margin-left:20px;">
        <a-button type="primary" @click="submit" ref="btnSave">查询</a-button>
      </a-form-item>
    </a-form>
    ...
    <a-table
      ...
      bordered
    >
      <span slot="status" slot-scope="text, records">{{records.status === 1 ? '登录成功' : '登录失败'}}</span>
    </a-table>
...
export default class LoginLog extends Vue {
  ...
  columns = [
    ...
    { title: "用户名", dataIndex: "adminName" },
    { title: "登录时间", dataIndex: "createTime" },
    { title: "登录IP", dataIndex: "ip" },
    { title: "浏览器", dataIndex: "browserInfo" },

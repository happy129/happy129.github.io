...
export default class BussinessServerManage extends Vue {
    table = {
        columns: [
            { title: 'ID',  dataIndex: 'groupId'},
            { title: 'Master节点', dataIndex: 'groupName'}, 
            { title: '机器名', dataIndex: 'userCount'}, 
            { title: '数据库IP', dataIndex: '2'}, 
            { title: '总数据库数', dataIndex: '3'}, 
            { title: '当前使用数量', dataIndex: '4'}, 
            { title: '创建时间', dataIndex: '5'}, 

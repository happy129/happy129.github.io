...
export default class Login extends Vue {
  ...
  submit(e) {
    ...
    this.form.validateFields((err, values) => {
      if (!err) {
        values.password = md5(values.password).toLowerCase();
  ...
  async loginAction(values) {
    ...
    const { data: response } = await this.Login({ ...values, deviceCode: "PC", appVersion:"beta", auxiliaryCode: "171fe4f7dba6ab45776f7159e60f74135879a1a", systemType: 10 });

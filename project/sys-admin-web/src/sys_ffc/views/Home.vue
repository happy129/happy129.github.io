<template>
  <div class="home-container">
    <div class="side-menu" :class="{'side-close': collapsed}">
        <side-menu title="分分彩控制" :collapsed="collapsed"/>
    </div>
    <div class="main-content" :class="{'side-close': collapsed}">
        <div class="main-page-header">
          <top-menu :name="userName" :isShowMessage="false" @toggleSide="toggleSide"/>
          <top-navigator />
        </div>
...
@Component
@InjectComponents({ SideMenu, TopMenu, TopNavigator })
